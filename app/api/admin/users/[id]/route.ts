...
export async function DELETE(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    return NextResponse.json({ message: "User deletion service temporarily unavailable" }, { status: 500 })
  }
}
...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    return NextResponse.json({ message: "User update service temporarily unavailable" }, { status: 500 })
  }
}
